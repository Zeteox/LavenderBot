...
public class PingCommand implements ICommand {
    ...
    public void execute(MessageReceivedEvent event, String[] args) {
        event.getMessage().reply( "Pong! \n" +
                "Les lavandes (Lavandula en latin) sont un genre de plantes à fleurs de la famille des Lamiaceae[1],[2], anciennement nommées Labiées.\n" +
                "\n" +
                ...
                "\n" +
                "Toutes les lavandes sont des plantes mellifères, c'est-à-dire très recherchées par les abeilles.").queue();
    }
}
